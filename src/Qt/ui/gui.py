...
"}"))
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.dirpathLine.sizePolicy().hasHeightForWidth())
        self.dirpathLine.setSizePolicy(sizePolicy)
        self.dirpathLine.setObjectName(_fromUtf8("dirpathLine"))
        self.verticalLayout.addWidget(self.dirpathLine)
        ...
        self.gridLayout.addWidget(self.plt, 0, 2, 1, 1)
