...
"}"))
        ...
        self.controlbar = QtGui.QHBoxLayout(self.horizontalFrame)
        self.controlbar.setObjectName(_fromUtf8("controlbar"))
        self.startButton = QtGui.QPushButton(self.horizontalFrame)
        self.startButton.setObjectName(_fromUtf8("startButton"))
        self.controlbar.addWidget(self.startButton)
        self.stopButton = QtGui.QPushButton(self.horizontalFrame)
        self.stopButton.setObjectName(_fromUtf8("stopButton"))
        self.controlbar.addWidget(self.stopButton)
        self.saveButton = QtGui.QPushButton(self.horizontalFrame)
